...
function drawRotatedImage(context, image, x, y, angle, height, width) {
    ...
    context.drawImage(image, -(image.width / 2), -(image.height / 2), height === null ? image.height : height, width === null ? image.width : width);
